...
///```
///
/// For the the resource to be loaded from the bundle of your package, you will also need to add the following extension somewhere in your package framework...
///
///```
